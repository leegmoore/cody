Topics [About](https://cookbook.openai.com/about) [API docs](https://platform.openai.com/docs/introduction) [Source](https://github.com/openai/openai-cookbook)
...
[Open in GitHub](https://github.com/openai/openai-cookbook/blob/main/examples/gpt-5/gpt-5-1_prompting_guide.ipynb) [View as Markdown](https://nbviewer.org/format/script/github/openai/openai-cookbook/blob/main/examples/gpt-5/gpt-5-1_prompting_guide.ipynb)

- [Introduction](https://cookbook.openai.com/examples/gpt-5/gpt-5-1_prompting_guide#introduction)
- [Migrating to GPT-5.1](https://cookbook.openai.com/examples/gpt-5/gpt-5-1_prompting_guide#migrating-to-gpt-51)
- [Agentic steerability](https://cookbook.openai.com/examples/gpt-5/gpt-5-1_prompting_guide#agentic-steerability)
- [Optimizing intelligence and instruction-following](https://cookbook.openai.com/examples/gpt-5/gpt-5-1_prompting_guide#optimizing-intelligence-and-instruction-following)
- [Maximizing coding performance from planning to execution](https://cookbook.openai.com/examples/gpt-5/gpt-5-1_prompting_guide#maximizing-coding-performance-from-planning-to-execution)
- [New tool types in GPT-5.1](https://cookbook.openai.com/examples/gpt-5/gpt-5-1_prompting_guide#new-tool-types-in-gpt-51)
- [How to metaprompt effectively](https://cookbook.openai.com/examples/gpt-5/gpt-5-1_prompting_guide#how-to-metaprompt-effectively)
- [What's next](https://cookbook.openai.com/examples/gpt-5/gpt-5-1_prompting_guide#whats-next)
...
### [Shaping your agent’s personality](https://cookbook.openai.com/examples/gpt-5/gpt-5-1_prompting_guide\#shaping-your-agents-personality)
...
### [Eliciting user updates](https://cookbook.openai.com/examples/gpt-5/gpt-5-1_prompting_guide\#eliciting-user-updates)
...
### [Encouraging complete solutions](https://cookbook.openai.com/examples/gpt-5/gpt-5-1_prompting_guide\#encouraging-complete-solutions)
...
### [Tool-calling format](https://cookbook.openai.com/examples/gpt-5/gpt-5-1_prompting_guide\#tool-calling-format)
...
### [Using the “none” reasoning mode for improved efficiency](https://cookbook.openai.com/examples/gpt-5/gpt-5-1_prompting_guide\#using-the-none-reasoning-mode-for-improved-efficiency)
...
### [Design system enforcement](https://cookbook.openai.com/examples/gpt-5/gpt-5-1_prompting_guide\#design-system-enforcement)
...
### [Using apply\_patch](https://cookbook.openai.com/examples/gpt-5/gpt-5-1_prompting_guide\#using-apply_patch)
...
### [Using the shell tool](https://cookbook.openai.com/examples/gpt-5/gpt-5-1_prompting_guide\#using-the-shell-tool)
