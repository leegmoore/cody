...
*   **Redis Driver:** `ioredis` is currently used for streaming operations due to `bun:redis` lacking necessary streaming commands. It should be replaced with `bun:redis` once streaming support is mature.
