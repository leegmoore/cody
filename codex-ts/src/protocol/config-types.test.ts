...
describe('Config Types Protocol', () => {
  describe('ReasoningEffort', () => {
    ...
    it('has exactly 4 reasoning effort levels', () => {
      const effortTypes = Object.keys(ReasoningEffort).filter((k) => isNaN(Number(k)));
    ...
    it('can be used in switch statements', () => {
      ...
      expect(getEffortDescription(ReasoningEffort.Minimal)).toBe('Fastest, least thorough');
      expect(getEffortDescription(ReasoningEffort.High)).toBe('Most thorough reasoning');
    });
  });
  ...
  describe('ReasoningSummary', () => {
    ...
    it('has exactly 4 reasoning summary formats', () => {
      const summaryTypes = Object.keys(ReasoningSummary).filter((k) => isNaN(Number(k)));
  ...
  describe('Verbosity', () => {
    ...
    it('has exactly 3 verbosity levels', () => {
      const verbosityTypes = Object.keys(Verbosity).filter((k) => isNaN(Number(k)));
  ...
  describe('SandboxMode', () => {
    ...
    it('has exactly 3 sandbox modes', () => {
      const modeTypes = Object.keys(SandboxMode).filter((k) => isNaN(Number(k)));
  ...
  describe('ForcedLoginMethod', () => {
    ...
    it('has exactly 2 login methods', () => {
      const methodTypes = Object.keys(ForcedLoginMethod).filter((k) => isNaN(Number(k)));
