...
describe('readMcpResource', () => {
  it('should reject missing server field', async () => {
    ...
    await expect(readMcpResource(params)).rejects.toThrow('missing server field')
  })
  ...
  it('should throw not implemented error for valid request', async () => {
    ...
    await expect(readMcpResource(params)).rejects.toThrow('not yet implemented')
  })
  ...
  it('should include server and uri in error message', async () => {
    ...
    await expect(readMcpResource(params)).rejects.toThrow('resource://data.json')
  })
})
...
describe('MCP_RESOURCE_TOOL_SPECS', () => {
  ...
  it('should not allow additional properties', () => {
    expect(MCP_RESOURCE_TOOL_SPECS.list_mcp_resources.parameters.additionalProperties).toBe(
      false,
    )
    expect(
      MCP_RESOURCE_TOOL_SPECS.list_mcp_resource_templates.parameters.additionalProperties,
    ).toBe(false)
    expect(MCP_RESOURCE_TOOL_SPECS.read_mcp_resource.parameters.additionalProperties).toBe(
      false,
    )
  })
})
